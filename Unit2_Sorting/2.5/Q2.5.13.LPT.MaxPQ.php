<?php
//php Q2.5.13.LPT.MaxPQ.php < Q2.5.13.input.txt
//replace the taskPQ from MinPQ to MaxPQ
//and the time spend is 7 times of the origin version
require("PQ.php");
$taskPQ=new MaxPQ(function(array $task1,array $task2){
